...
type VaultClient struct {
	...
	clientMu      sync.Mutex                     `yaml:"-" json:"-"` // Guards lazy api.Client construction
}
...
func (in *VaultClient) DeepCopyInto(out *VaultClient) {
	...
	// Pointers/interfaces copied as-is; lock fields intentionally zeroed to avoid copying locks
	out.Client = in.Client
	out.logicalClient = in.logicalClient
	out.breaker = in.breaker
	out.breakerOnce = sync.Once{}
	out.clientMu = sync.Mutex{}
}
...
func (vc *VaultClient) ensureAPIClient() (*api.Client, error) {
	...
	client.AddHeader("x-vault-sync", "true")
	vc.Client = client
	return vc.Client, nil
}
