...
- **Source Code**: Available in the [SecretSync package directory](https://github.com/jbcom/secrets-sync)
...
- Posted to the [SecretSync repository](https://github.com/jbcom/secrets-sync)
...
- **Security**: See [SECURITY.md](https://github.com/jbcom/secrets-sync/blob/main/docs/SECURITY.md)
...
SecretSync is licensed under the [MIT License](https://github.com/jbcom/secrets-sync/blob/main/LICENSE).
