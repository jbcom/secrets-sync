...
- [func RecordDuration\(histogram \*prometheus.HistogramVec, start time.Time, labels ...string\)](<#RecordDuration>)
- [func RecordError\(counter \*prometheus.CounterVec, labels ...string\)](<#RecordError>)
...
<a name="Handler"></a>
## func [Handler](<https://github.com/jbcom/secrets-sync/blob/main/pkg/observability/metrics.go#L227>)
...
## func [RecordDuration](<https://github.com/jbcom/secrets-sync/blob/main/pkg/observability/metrics.go#L234>)
...
## func [RecordError](<https://github.com/jbcom/secrets-sync/blob/main/pkg/observability/metrics.go#L240>)
