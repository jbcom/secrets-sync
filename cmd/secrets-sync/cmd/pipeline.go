...
Examples:
  ...
  secrets-sync pipeline --config config.yaml --dry-run --output github

  # Visual side-by-side diff output
  secrets-sync pipeline --config config.yaml --dry-run --output side-by-side

  # Specific targets only
  secrets-sync pipeline --config config.yaml --targets "Serverless_Stg,Serverless_Prod"
  ...
  secrets-sync pipeline --config config.yaml --diff`,
	RunE: runPipeline,
}
