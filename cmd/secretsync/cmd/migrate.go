...
# Generated by: secretsync migrate --from terraform-secretsmanager
#
...
`
	...
	fmt.Println("   3. Validate: secretsync validate --config " + outputFile)
	fmt.Println("   4. Dry run: secretsync pipeline --config " + outputFile + " --dry-run")
